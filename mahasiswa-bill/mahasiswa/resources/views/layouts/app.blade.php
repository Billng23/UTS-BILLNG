...
<body>
    ...
    <main id="main">
        ...
        <section id="resume" class="resume">
            <div class="container" data-aos="fade-up">
                ...
                <p> Nama : Bill Ng<?php echo $biodata[0]->nama?></p>
                <p> Student ID : 03081200037<?php echo $biodata[0]->StudentID?></p>
    ...
    <footer id="footer">
        <div class="container">
            <div class="copyright">
                &copy; Copyright <strong><span>Bill ng</span></strong>. All Rights Reserved
            </div>
        </div>
    </footer><!-- End  Footer -->
